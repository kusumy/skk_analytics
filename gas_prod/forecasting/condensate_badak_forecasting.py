...
def main():
    ...
    query_1 = open("condensate_badak_data_query.sql", mode="rt").read()
    ...
    query_2 = open("condensate_badak_exog_query.sql", mode="rt").read()
    ...
    #Rename colum 0
    y_pred_poly3.rename(columns={0:'forecast_g'}, inplace=True)
