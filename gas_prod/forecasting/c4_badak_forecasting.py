...
def main():
    ...
    try:
        ...
        sarimax_model = ARIMA(order=(2, 1, 0), seasonal_order=(1, 1, 1, 12), suppress_warnings=sarimax_suppress_warnings)
        ...
        ranfor_forecaster.fit(train_df) #, train_exog
        ...
        xgb_forecaster.fit(train_df) #, train_exog
