...
def main():
    ...
    best_model = [{'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'a', 'mape': arimax_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'b', 'mape': sarimax_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'c', 'mape': prophet_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'd', 'mape': ranfor_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'e', 'mape': xgb_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'f', 'mape': linreg_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'g', 'mape': poly2_mape_adj},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Feed Gas', 'model_choosen': 'h', 'mape': poly3_mape_adj}]
