...
def main():
    ...
    linreg_forecaster_param_grid = {"window_length": [2, 6, num_lags, 7]}
    ...
    best_model = [{'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'a', 'mape': arimax_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'b', 'mape': sarimax_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'c', 'mape': prophet_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'd', 'mape': ranfor_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'e', 'mape': xgb_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'f', 'mape': linreg_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'g', 'mape': poly2_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Feed Gas', 'model_choosen': 'h', 'mape': poly3_mape_adj}]
...
def update_model_config(conn, model_choosen, lng_plant, lng_parameter):
    ...
    sql = """   UPDATE model_config_daily
                SET model_choosen = %s,
                    updated_at = %s,
                    updated_by = %s
                WHERE lng_plant = 'BP Tangguh' AND lng_parameter = 'Feed Gas'
          """
