...
# For example : We will run this script only, we can comment (#) script main_lng_insample.py on other script .py (example: condensate_tangguh_forecasting_insample.py etc.)
...
def main():
    ...
    sarimax_fit = sarimax_model.fit(y_train_cleaned, X=X_train)
    ...
    arimax_fit = arimax_model.fit(y_train_cleaned, X=X_train)
    ...
    # create regressor object
    ranfor_forecaster_param_grid = {"window_length": [3, 6, num_lags], 
    ...
    xgb_forecaster_param_grid = {"window_length": [3, 6, num_lags]
    ...
    linreg_forecaster_param_grid = {"window_length": [3, 6, num_lags]}
    ...
    best_model = [{'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'a', 'mape': arimax_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'b', 'mape': sarimax_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'c', 'mape': prophet_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'd', 'mape': ranfor_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'e', 'mape': xgb_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'f', 'mape': linreg_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'g', 'mape': poly2_mape_adj},
                {'lng_plant': 'BP Tangguh', 'lng_parameter': 'Condensate', 'model_choosen': 'h', 'mape': poly3_mape_adj}]
...
def update_model_config(conn, model_choosen, lng_plant, lng_parameter):
    ...
    sql = """   UPDATE model_config_daily
                SET model_choosen = %s,
                    updated_at = %s,
                    updated_by = %s
                WHERE lng_plant = 'BP Tangguh' AND lng_parameter = 'Condensate'
          """
