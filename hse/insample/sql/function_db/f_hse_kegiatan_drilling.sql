CREATE OR REPLACE FUNCTION public.f_hse_kegiatan_drilling()
 RETURNS TABLE(year_num integer, month_num integer, survei_seismic bigint, survei_seismic_cum bigint, drilling_explor numeric, drilling_explor_cum numeric, drilling_explot numeric, drilling_explot_cum numeric, workover numeric, workover_cum numeric, wellservice numeric, wellservice_cum numeric)
 LANGUAGE plpgsql
AS $function$
