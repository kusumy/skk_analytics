...
# %%
# Prepare data
file = 'condensate_unplanned-planned_shutdown_cleaned_with.csv'
...
mape_data_condensate =  {'arimax': [arimax_mape_str],
             'sarimax': [sarimax_mape_str],
             'prophet': [prophet_mape_str],
             'random_forest': [ranfor_mape_str],
             'xgboost': [xgb_mape_str],
             'linear_regression': [linreg_mape_str],
             'polynomial_degree_2': [poly2_mape_str],
             'polynomial_degree_3': [poly3_mape_str]}
...
def update_trir(forecast, prod_date):
    ...
    sql = """ UPDATE lng_condensate_daily
                SET forecast_a = %s, forecast_b = %s, forecast_c = %s,
                forecast_d = %s, forecast_e = %s, forecast_f = %s,
                forecast_g = %s, forecast_h = %s
                WHERE prod_date = %s
