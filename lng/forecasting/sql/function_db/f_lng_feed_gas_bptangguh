CREATE OR REPLACE FUNCTION public.f_lng_feed_gas_bptangguh(lngplant character varying, startdate date, enddate date)
...
AS $function$ 
	...
	begin
		...
		_query = _query || ' from lng_feed_gas_daily as prod ';
