...
def main():
    ...
    logs_file_path = str(logs_folder/'feed_gas_badak_forecasting.log')
    #logs_file_path = os.path.join('./logs', 'feed_gas_badak_forecasting.log')
    ...
    try:
        ...
        poly_lags = poly2_model_param['window_length']
