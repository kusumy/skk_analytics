...
def main():
    ...
    logs_file_path = str(logs_folder/'lng_production_badak_insample.log')
    ...
    # Create regressor object
    linreg_forecaster_param_grid = {"window_length": [2, 7, 8]}
    ...
    best_model = [{'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'a', 'mape': arimax_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'b', 'mape': sarimax_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'c', 'mape': prophet_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'd', 'mape': ranfor_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'e', 'mape': xgb_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'f', 'mape': linreg_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'g', 'mape': poly2_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'LNG Production', 'model_choosen': 'h', 'mape': poly3_mape}]
