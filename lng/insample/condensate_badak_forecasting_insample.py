...
# Data source from the SKK Migas (10.6.7.74) database in the lng_condensate_daily table with lng_plant = 'PT Badak'.
...
# For example : We will run this script only, we can comment (#) script main_lng_insample.py on other script .py (example: condensate_badak_forecasting_insample.py etc.)
...
def main():
    ...
    sarimax_forecast = sarimax_fit.predict(fh, X=X_test) #SKTIME
    ...
    # Calculate mean condensate data testing
    #test_mean = df_adjustment_sarimax['condensate'].mean()
    ...
    #sarimax_mape_adj = mean_absolute_percentage_error(df_adjustment_sarimax['condensate'], df_adjustment_sarimax['sarimax_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #arimax_mape_adj = mean_absolute_percentage_error(df_adjustment_arimax['condensate'], df_adjustment_arimax['arimax_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #prophet_mape_adj = mean_absolute_percentage_error(df_adjustment_prophet['condensate'], df_adjustment_prophet['prophet_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #ranfor_mape_adj = mean_absolute_percentage_error(df_adjustment_ranfor['condensate'], df_adjustment_ranfor['ranfor_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #xgb_mape_adj = mean_absolute_percentage_error(df_adjustment_xgb['condensate'], df_adjustment_xgb['xgb_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #linreg_mape_adj = mean_absolute_percentage_error(df_adjustment_linreg['condensate'], df_adjustment_linreg['linreg_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #poly2_mape_adj = mean_absolute_percentage_error(df_adjustment_poly2['condensate'], df_adjustment_poly2['poly2_forecast_add'])
    ...
    # Calculate MAPE Value after adjustment value
    #poly3_mape_adj = mean_absolute_percentage_error(df_adjustment_poly3['condensate'], df_adjustment_poly3['poly3_forecast_add'])
    ...
    best_model = [{'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'a', 'mape': arimax_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'b', 'mape': sarimax_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'c', 'mape': prophet_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'd', 'mape': ranfor_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'e', 'mape': xgb_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'f', 'mape': linreg_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'g', 'mape': poly2_mape},
                {'lng_plant': 'PT Badak', 'lng_parameter': 'Condensate', 'model_choosen': 'h', 'mape': poly3_mape}]
...
def update_model_config(conn, model_choosen, lng_plant, lng_parameter):
    ...
    sql = """   UPDATE model_config_daily
                SET model_choosen = %s,
                    updated_at = %s,
                    updated_by = %s
                WHERE lng_plant = 'PT Badak' AND lng_parameter = 'Condensate'
          """
