...
def main():
    ...
    # Create ARIMAX Model
    arimax_model = AutoARIMA(d=arimax_differencing, trace=arimax_trace, n_fits=arimax_n_fits, error_action=arimax_error_action, suppress_warnings=arimax_suppress_warnings,
